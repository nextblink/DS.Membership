...
namespace Marsipan.Membership.Middleware.Migrations
{
    ...
    [Migration("20260517122915_AddPartyHierarchy")]
    partial class AddPartyHierarchy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marsipan.Membership.Middleware.Entities.MemberFunction", b =>
                {
                    ...
                    b.HasIndex("MemberId", "FunctionId", "OrgUnitId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Marsipan.Membership.Middleware.Entities.Municipality", b =>
                {
                    b.HasOne("Marsipan.Membership.Middleware.Entities.OrgUnit", null)
                        .WithMany()
                        .HasForeignKey("OoId")
