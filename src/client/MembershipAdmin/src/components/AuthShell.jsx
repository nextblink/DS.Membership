...
/*
  Shared chrome for the unauthenticated pages (login, reset password, …).
...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  /* body copy inside the form panel */
  .lp-note {
    font-size: 0.85rem;
    color: #6b7f92;
    line-height: 1.6;
      ...
      <div className="lp-root">
        ...
        <div className="lp-brand">
          ...
          <div className="lp-brand-mid">
            ...
            <p className="lp-desc">
              Централизована евиденција, организациона хијерархија и аналитика — све на једном месту.
            </p>
          </div>
        ...
        <div className="lp-form-panel">
          <div className="lp-form-header">
            {eyebrow && <div className="lp-form-eyebrow">{eyebrow}</div>}
            <h2 className="lp-form-title">{title}</h2>
            {subtitle && <p className="lp-form-sub">{subtitle}</p>}
          </div>
